                                   ...
                                   fluidRow(
                                       box(title = strong("Fibrosis stage and liver related mortality risk"),
                                           ...
                                           a("Hagstrom et al, Journal of Hepatology 2017", href = "https://pubmed.ncbi.nlm.nih.gov/28803953/", target = "_blank"),
                                            "). This presents a challenge to treatments that aim to prevent progression of liver disease, 
                                           ...
                                           br(),
                                           br(),
                                           "Estimates of the incidence of decompensation and hepatocellular carcinoma (HCC) were informed by rates observed in primary studies (",
